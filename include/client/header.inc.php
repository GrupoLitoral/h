...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>scp/css/typeahead.css?e148727"
         media="screen" />
    <link type="text/css" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.13.1.custom.min.css?e148727"
        ...
        <div id="header">
            ...
            <?php
                ...
                if ($cfg->getClientRegistrationMode() == 'public') { ?>
                    <a id="signIN" href="<?php echo ROOT_PATH; ?>scp/"><?php echo __('Panel Administrador'); ?></a><?php
                }
                ...
                elseif ($cfg->getClientRegistrationMode() != 'disabled') { ?>
                    <a id="punto" href="<?php echo $signin_url; ?>"><?php echo __('.'); ?></a>
